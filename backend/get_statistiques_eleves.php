...
try {
    // 1. Récupérer les élèves (DISTINCT pour sécurité maximale)
    ...
    // 2. Trier par moyenne décroissante pour donner les rangs
    usort($stats, function($a, $b) {
        return $b['moyenne'] <=> $a['moyenne'];
    });

    // 3. Ajouter les rangs (avec gestion des ex-aequo)
    $rank = 1;
    ...
    unset($s); // Important : rompre la référence pour éviter les doublons dans la boucle suivante

    // 4. Calculer les statistiques globales et par classe

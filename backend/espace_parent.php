...
// 2. Récupération de l'élève lié à ce parent
$parent_user_id = $_SESSION['parent_id'];

try {
    // Cette requête fait le pont entre l'utilisateur connecté (le parent) et son enfant
    ...
    // On récupère tous les enfants liés (au cas où il y en a plusieurs)
